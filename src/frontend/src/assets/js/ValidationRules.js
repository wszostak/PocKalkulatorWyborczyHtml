...
function validate() {
	...
	try {
		...
		var pole_1_6 = getInt('liczba_1_6', 'Liczba wyborców głosujących na podstawie '+
		...
		var pole_1_8_a = getInt('liczba_1_8_a', 'Liczba kopert zwrotnych, w których nie było '+
			'oświadczenia o osobistym i tajnym oddaniu głosu');
		var pole_1_8_b = getInt('liczba_1_8_b', 'Liczba kopert zwrotnych, w których'+
			' oświadczenie nie było podpisane przez wyborcę');
		var pole_1_8_c = getInt('liczba_1_8_c', 'Liczba kopert zwrotnych, w których'+
			' nie było koperty na kartę do głosowania');
		var pole_1_8_d = getInt('liczba_1_8_d', 'Liczba kopert zwrotnych, w których '+
		...
		check(roznica < dopuszczalny_blad, 'Liczba wyborców uprawnionych do głosowania jest różna od'+
			' liczby osób z ostatniego meldunku wyborczego ('+liczba_osob_meldunek+') o wiecej niż 10%.');

		var min_liczba_kart = 0.8 * pole_1_1;
		check(pole_1_2 >= min_liczba_kart, 'Liczba otrzymanych kart do głosowania jest mniejsza, '+
			'niż 80% liczby wyborów uprawnionych do głosowania.');

		var suma = parseInt(pole_1_3) + parseInt(pole_1_4);

		check(suma === pole_1_2, 'Suma liczb z pkt. 3 i 4 powinna być równa liczbie z pkt. 2.'+
		...
		var suma_pole_8a_8e = parseInt(pole_1_8_a) + parseInt(pole_1_8_b) + parseInt(pole_1_8_c) + 
								parseInt(pole_1_8_d) + parseInt(pole_1_8_e);

		check(suma_pole_8a_8e <= parseInt(pole_1_8), 'Suma liczba z pkt. 8a–8e nie '+
